SELECT
5441 AS layer_code, 'nonop' AS layer_class, 'service_construction' AS layer_name, feature_type AS gdal_type, osm_id, osm_way_id, osm_timestamp, all_tags, geometry
